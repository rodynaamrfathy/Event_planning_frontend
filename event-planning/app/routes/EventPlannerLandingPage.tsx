...
export default function EventPlannerLandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-gray-950 dark:to-gray-900 text-gray-800 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between px-10 py-20 text-gray-800 dark:text-gray-100">
        <motion.div
          ...
          className="max-w-lg"
        >
          <h2 className="text-5xl font-bold mb-4 leading-tight text-gray-900 dark:text-gray-100">
      ...
      {/* Features */}
      <section id="features" className="px-10 py-20 bg-white dark:bg-gray-950 text-gray-800 dark:text-gray-100">
        <h3 className="text-3xl font-semibold text-center mb-12 text-gray-900 dark:text-gray-100">Why Choose EventPlanner?</h3>
        <div className="grid md:grid-cols-3 gap-10">
          <div className="p-8 rounded-2xl shadow hover:shadow-lg transition bg-gray-50 dark:bg-gray-900">
            <CalendarDays className="text-blue-600 mb-4 w-10 h-10" />
            <h4 className="text-xl font-semibold mb-2">Smart Scheduling</h4>
            <p className="text-gray-600 dark:text-gray-300">Automatically manage and sync all your events with real-time updates.</p>
          </div>
          <div className="p-8 rounded-2xl shadow hover:shadow-lg transition bg-gray-50 dark:bg-gray-900">
            <Users className="text-blue-600 mb-4 w-10 h-10" />
            <h4 className="text-xl font-semibold mb-2">Invite & Collaborate</h4>
            <p className="text-gray-600 dark:text-gray-300">Send invites, track RSVPs, and coordinate tasks with your team or guests.</p>
          </div>
          <div className="p-8 rounded-2xl shadow hover:shadow-lg transition bg-gray-50 dark:bg-gray-900">
            <Sparkles className="text-blue-600 mb-4 w-10 h-10" />
            <h4 className="text-xl font-semibold mb-2">All-in-One Dashboard</h4>
            <p className="text-gray-600 dark:text-gray-300">View your events, upcoming tasks, and invites all in one sleek dashboard.</p>
          </div>
        </div>
      </section>
    ...
    {/* Contact Section */}
      <section
        id="contact"
        className="px-10 py-20 bg-blue-50 dark:bg-blue-900/20 border-t border-gray-200 dark:border-gray-800 text-center text-gray-800 dark:text-gray-100"
      >
        <motion.div
        ...
        >
          <h3 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Contact Us</h3>
